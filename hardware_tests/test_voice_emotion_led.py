...
# =========================
# Cloud Mood Lamp
# Voice → STT → AI Emotion → LED + Vibration Test
# =========================
...
def record_audio():
    """
    INMP441 마이크로 RECORD_SECONDS초 동안 녹음해서 wav 파일로 저장한다.
    """
...
def show_intro():
    print()
    print("=================================")
    print("Cloud Mood Lamp Voice + AI + LED Test")
    print("---------------------------------")
    print("Enter를 누르면 마이크 녹음이 시작됩니다.")
    print("녹음된 말을 STT로 텍스트 변환하고,")
    print("AI가 감정을 판단한 뒤 LED + 진동 효과를 실행합니다.")
    print()
    print("종료하려면 quit 입력")
...
try:
    ...
    while True:
        user_input = input("\nEnter = 녹음 시작 / off = 끄기 / quit = 종료 > ").strip().lower()
        ...
        try:
            ...
            if not text:
                print("텍스트가 비어 있습니다. 다시 말해보세요.")
                continue

            print()
            print("AI가 감정을 판단하는 중...")
